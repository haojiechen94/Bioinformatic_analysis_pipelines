...
if [ "$seq_type" = "ATAC" ];
    then
        ...
        mkdir -m 775 -p $temp_dir
        trim_galore --paired -o $temp_dir --fastqc $treatment_read1_fq_gz $treatment_read2_fq_gz;
    ...
    then
        ...
        mkdir -m 775 -p $temp_dir
        trim_galore --paired -o $temp_dir --fastqc $control_read1_fq_gz $control_read2_fq_gz;
    ...
    then
        ...
        temp_dir="$output_dir/step1_fastqc_and_trim_galore/trim_galore/$name/treatment/"
        mkdir -m 775 -p $temp_dir            
        trim_galore -o $temp_dir --fastqc $treatment_fq_gz;
        temp_dir="$output_dir/step1_fastqc_and_trim_galore/trim_galore/$name/control/"
        mkdir -m 775 -p $temp_dir            
        trim_galore  -o $temp_dir --fastqc $control_fq_gz;
else
